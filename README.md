...
docker buildx build --platform linux/arm64,linux/amd64 \
  -t rselagam/stochsuite:v4_ubuntu_24.04 \
  --push .
```
...
```
docker pull rselagam/stochsuite:v4_ubuntu_24.04
```
...
```
docker run -it --rm -w /root -e "STOCHSUITE_HOME=/root/stochsuite"  rselagam/stochsuite:v4_ubuntu_24.04 /bin/bash -c "git clone https://github.com/BujSet/stochsuite.git && cd stochsuite/ && /bin/bash"
```
